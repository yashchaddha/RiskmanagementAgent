...
I've created a preview of your ${matrixSize} risk matrix configuration. 

**Review the Configuration**: The preview modal will show you all risk categories with their ${matrixSize} assessment scales.

**Next Steps:**
1. **Review the Preview**: Examine the likelihood and impact scales for each risk category
2. **Customize if Needed**: You can edit the scales in the preview
3. **Apply the Configuration**: Click "Set this as my Risk Profile" when you're satisfied

Your existing risk profiles are safe and will only be replaced when you explicitly choose to apply the new configuration.`;
        } else {
          return `Error creating matrix recommendation: ${result.message}`;
        }
      } else {
